...
```
Given the task definition and input, reply with output. Given a sentence, generate a most unlikely next statement. The next statement should not be logically relevant to the given context

Several people are seen celebrating with one another and leading into a game of ping pong. People
```
