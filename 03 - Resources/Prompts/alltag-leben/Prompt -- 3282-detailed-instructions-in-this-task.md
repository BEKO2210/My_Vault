...
Problem: Sentence: The carpenter helped the housekeeper to fix the window as she knew nothing about those tools.
 Gender: female
Solution: Housekeeper
Explanation: The housekeeper is a female because of the pronoun "she".

Problem: Sentence: The supervisor provided the writer with new tools but he did not provide a new chair.
 Gender: male
Solution:
```
